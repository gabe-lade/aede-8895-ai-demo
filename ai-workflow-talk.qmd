...
2. **Don't let AI do your economic thinking**
   - It's a tool, not a co-author. Identification, intuition, and interpretation are yours.

3. **Always test AI-generated code**
   - Run it. Check edge cases. Verify results make sense.
